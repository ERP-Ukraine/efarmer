...
class IntegrationEcommerceProductImageMapping(models.Model):
    _name = 'integration.ecommerce.product.image.mapping'
    ...
    def apply_binary_data(self, b64_bytes):
        ...
        if self.is_cover:
            ...
            image = self.env['ecommerce.product.image'].create({
