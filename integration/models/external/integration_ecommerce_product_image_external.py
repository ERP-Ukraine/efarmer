...
class IntegrationEcommerceProductImageExternal(models.Model):
    _name = 'integration.ecommerce.product.image.external'
    _description = 'E-Commerce Product Image External'
    ...
    mapping_ids = fields.One2many(
        comodel_name='integration.ecommerce.product.image.mapping',
    ...
    def _create_image_mapping(self, **kwargs):
        self.ensure_one()
        return self.env['integration.ecommerce.product.image.mapping'].create({
            **kwargs,
