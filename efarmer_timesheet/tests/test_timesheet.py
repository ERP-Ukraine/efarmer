...
class TestHrTimesheet(TransactionCase):
    ...
    def test_compute_outstaff_timesheet_cost(self):
        ...
        self.assertEqual(outstaff.timesheet_cost, 7.17)
        ...
        outstaff.compute_timesheet_cost()
        self.assertEqual(outstaff.timesheet_cost, 29.88)
        ...
        # expected res: 30
        outstaff.compute_timesheet_cost()
        self.assertEqual(outstaff.timesheet_cost, 30)

        outstaff.paid_per = 'day'

        # expected res: 0
        outstaff.compute_timesheet_cost()
        self.assertEqual(outstaff.timesheet_cost, 0)
