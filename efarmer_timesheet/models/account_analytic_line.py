...
class AccountAnalyticLine(models.Model):
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if 'rate_per_hour' not in vals:
                ...
                if employee:
                    vals.update({'rate_per_hour': employee.timesheet_cost})
    ...
    def _compute_capital_values(self):
        for line in self:
            ...
            percent_capital_labour_cost = capital_labour_cost / line.amount if line.amount else 0.0
    ...
    def read_group(self, domain, fields, groupby,
        ...
        """
        Failed with group_operator='avg': 100% + 0%(line without amount) = 50%.
