...
class JpkVAT7MReportWizard(models.TransientModel):
    _name = 'jpk.vat7m.v3.report.wizard'
    _description = 'JPK VAT 7M V3 Report Wizard'
    _inherit = 'jpk.vat7m.report.wizard'

    def _print_report(self, report_type):
        self.ensure_one()
        data = self._prepare_vat_report()
        report_name = 'trilab_jpk_vat.jpk_vat7m_v3_report'
        ...
        if report_type == 'xlsx':
            return {
                ...
                'report_file': 'trilab_jpk_vat.jpk_vat7m_v3_report',
                'name': 'VAT 7M (3) 1-0E',
                'data': data,
            }
    ...
    def _create_jpk_vat7m_report(self, data):
        ...
        xml, sums = self.env['report.trilab_jpk_vat.jpk_vat7m_v3_report'].get_xml_extended(data)
    ...
    def get_print_report_name(self, prefix='vat_7m_v3'):
