...
API_WORK_ITEM_RESPONSE = [
    {
        "date": 1670198400000,
        "duration": {"minutes": 62, "$type": "DurationValue"},
        "issue": {
            "project": {"id": "1-1", "shortName": "TEST", "$type": "Project"},
            "id": "99-99",
            "$type": "Issue",
        },
...
API_TASK_RESPONSE = {
    ...
    "customFields": [
        ...
        {
            "value": {"minutes": 660, "id": "P1DT3H", "$type": "PeriodValue"},
            "name": "Estimation",
            "$type": "PeriodIssueCustomField",
        },
        {"value": None, "name": "Name PL", "$type": "TextIssueCustomField"},
        {"value": None, "name": "Product", "$type": "SingleEnumIssueCustomField"},
        {
            "value": None,
...
API_PARENT_TASK_RESPONSE = {
    ...
    "customFields": [
        ...
        {
            "value": {"minutes": 550, "id": "P1DT", "$type": "PeriodValue"},
            "name": "Estimation",
            "$type": "PeriodIssueCustomField",
        },
        {
