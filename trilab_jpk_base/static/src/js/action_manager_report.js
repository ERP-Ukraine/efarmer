...
registry.category("ir.actions.report handlers").add("jpk_xlsx_handler", async function (action, options, env) {
    if (action.report_type === "jpk_xlsx" || action.report_type === "jpk_xml") {
