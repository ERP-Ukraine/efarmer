...

{
    ...
    'summary': """
        ...
        Enterprise, Odoo.sh.
        Keywords: ZPL Label Print | Zebra Printer Odoo | Odoo Label Printing | Direct Print Labels |
        Thermal Label Printing | Auto Print Odoo | Label Printer Integration | Odoo Barcode Print |
        Odoo Label Designer | Print from Odoo | Odoo Print Bridge | No IoT Box | Network Label Printing |
        USB Printer Odoo | Odoo Manufacturing Labels | Inventory Label Printing | ZPL Print from Odoo |
        Odoo Print Automation
    """,
    'version': '15.0.1.1.0',
    'category': 'Tools',
